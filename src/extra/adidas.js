      ...
      <div className="page1">
        ...
        <div id="details">
          ...
          <div class="about">
            ...
            <p>Inspired by a '90s archive edition, these adidas shoes get their design cred from a     chunky, expressive silhouette re-proportioned for modern style. Stylised synthetic suede overlays accent a flexible mesh upper, and it all rides on a rubber outsole for traction and a solid step.</p>
          </div>
        </div>
      </div>
    </div>
